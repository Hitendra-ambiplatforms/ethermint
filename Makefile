...
docker-build:
	...
	docker create --name ethermint -t -i Ambiplatforms-TORQUE/ethermint:latest ethermint
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/Ambiplatforms-TORQUE/ethermint/types"
	godoc -http=:6060
...
test-import:
	go test -run TestImporterTestSuite -v --vet=off github.com/Ambiplatforms-TORQUE/ethermint/tests/importer
